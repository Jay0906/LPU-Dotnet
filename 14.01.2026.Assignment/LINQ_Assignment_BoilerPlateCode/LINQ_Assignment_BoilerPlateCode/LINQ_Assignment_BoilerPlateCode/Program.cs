...
namespace LINQ_Assignment_BoilerPlateCode
{
    class Program
    {
        ...
        static List<Employee> GetHighEarningEmployees(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.Where(n => n.Salary > 60000).ToList();
                return res;
            }
            catch
            {
        ...
        static List<string> GetEmployeeNames(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.Select(n => n.Name).ToList();
                return res;
            }
            catch
            {
        ...
        static bool HasHREmployees(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.Any(n => n.Department.Equals("HR"));
                return res;
            }
            catch
            {
        ...
        static List<DepartmentCount> GetDepartmentWiseCount(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.GroupBy(n => n.Department).Select(g => new DepartmentCount
                {
                    Department = g.Key,
                    Count = g.Count()
                }).ToList();
        ...
        static Employee GetHighestPaidEmployee(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.OrderByDescending(n => n.Salary).First();
                return res;
            }
            catch
            {
        ...
        static List<Employee> SortEmployeesBySalaryAndName(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.OrderByDescending(n => n.Salary).ThenBy(n=>n.Name).ToList();
                return res;
            }
            catch
            {
        ...
        static List<string> GetAllUniqueSkills(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.Where(n => n.Skills != null).SelectMany(n => n.Skills).Distinct().ToList();
                return res;
            }
            catch
            {
            ...
            List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.GroupBy(n => n.Department).Select(g => new DepartmentTopEmployees
                {
                    Department = g.Key,
        ...
        static List<Employee> RemoveDuplicateEmployees(List<Employee> employees)
        {
            ...
            try
            {
                var res = employees.GroupBy(n => n.Id).Select(g => g.First()).ToList();
                return res;
            }
            catch
            {
